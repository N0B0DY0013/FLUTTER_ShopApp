...
class _EditProductState extends State<EditProduct> {
    ...
    if (_isInit) {
      ...
      if (page_args["type"] == "existing") {
        ...
        _imgURLController.text =
            "https://i.pinimg.com/originals/cf/0b/be/cf0bbe0e35bc5f92b10045852f87bb11.jpg";
      }
    }
    _isInit = false;
      ...
      showDialog(
        ...
        builder: (ctx) {
          return AlertDialog(
            ...
            content: Text(page_args["type"] == "new"
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(
            (page_args["type"] == "new") ? "Add New Product" : "Edit Product"),
        actions: [
          IconButton(
            onPressed: _saveForm,
